...
export const TaskDetailsMain = ({ task, boardId, groupId, labels, activities }) => {
    return <div className="task-details-main">
        <DataGutter boardId={boardId} groupId={groupId} task={task} labels={labels} />
        <TaskDetailsMainCmps task={task} boardId={boardId} groupId={groupId} activities={activities} />
    </div>
}
